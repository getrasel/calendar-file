...
<div class="row">
  ...
  <div class="col-xl-6">
    ...
    <div class="nav-align-bottom nav-tabs-shadow mb-4">
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
        ...
        <li class="nav-item"><button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-bottom-profile" aria-controls="navs-bottom-profile" aria-selected="false">Profile</button>
        </li>
        <li class="nav-item">
