    ...
    <div class="container">
      ...
      <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img src="{{asset('assets/img/front-pages/icons/laptop.svg')}}" alt="laptop charging" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img src="{{asset('assets/img/front-pages/icons/rocket.svg')}}" alt="transition up" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img src="{{asset('assets/img/front-pages/icons/paper.svg')}}" alt="edit" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img src="{{asset('assets/img/front-pages/icons/check.svg')}}" alt="3d select solid" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img src="{{asset('assets/img/front-pages/icons/user.svg')}}" alt="user" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img src="{{asset('assets/img/front-pages/icons/keyboard.svg')}}" alt="keyboard" />
          </div>
      ...
      <div class="row gy-6">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card border border-success shadow-none">
            <div class="card-body text-center">
              <img src="{{asset('assets/img/front-pages/icons/user-success.svg')}}" alt="laptop" class="mb-4" />
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card border border-info shadow-none">
            <div class="card-body text-center">
              <img src="{{asset('assets/img/front-pages/icons/diamond-info.svg')}}" alt="laptop" class="mb-4" />
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card border border-warning shadow-none">
            <div class="card-body text-center">
              <img src="{{asset('assets/img/front-pages/icons/check-warning.svg')}}" alt="laptop" class="mb-4" />
