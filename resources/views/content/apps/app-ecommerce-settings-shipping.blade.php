      ...
      <ul class="nav nav-align-left nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/app/ecommerce/settings/notifications')}}">
            <i class="bx bx-bell bx-sm me-1_5"></i>
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div>
                <a href="javascript:void(0);" class="btn btn-sm btn-icon text-secondary me-1"><i class='bx bx-pencil'></i></a>
                <a href="javascript:void(0);" class="btn btn-sm btn-icon text-secondary"><i class='bx bx-trash'></i></a>
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-4">
                          <button type="button" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded bx-md"></i></button>
                    ...
                    <tr>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-4">
                          <button type="button" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded bx-md"></i></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-edit me-2"></i> Edit</a>
