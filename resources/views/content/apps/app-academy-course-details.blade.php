        ...
        <div class="card academy-content shadow-none border">
          ...
          <div class="card-body pt-4">
            ...
            <div class="d-flex flex-wrap row-gap-2">
              <div class="me-12">
                <p class="text-nowrap mb-2"><i class='bx bx-check me-2 align-bottom'></i>Skill level: All Levels</p>
                <p class="text-nowrap mb-2"><i class='bx bx-group me-2 align-top'></i>Students: 38,815</p>
                <p class="text-nowrap mb-2"><i class='bx bx-globe me-2 align-bottom'></i>Languages: English</p>
                <p class="text-nowrap mb-0"><i class='bx bx-file me-2 align-bottom'></i>Captions: Yes</p>
              </div>
              <div>
                <p class="text-nowrap mb-2"><i class='bx bx-video me-2 align-top ms-50'></i>Lectures: 19</p>
                <p class="text-nowrap mb-0"><i class='bx bx-time-five me-2 align-top'></i>Video: 1.5 total hours</p>
              </div>
            </div>
            <hr class="my-6">
            <h5>Description</h5>
