  ...
  <div class="card p-0 mb-6">
    <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-6">
      ...
      <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center mb-6 py-6">
        ...
        <p class="mb-4">
          Grow your skill with the most reliable online courses and certifications in<br>marketing, information technology,
          programming, and data science.
        </p>
        <div class="d-flex align-items-center justify-content-between app-academy-md-80">
          <input type="search" placeholder="Find your course" class="form-control me-4" />
          <button type="submit" class="btn btn-primary btn-icon"><i class="bx bx-search bx-md"></i></button>
        </div>
      </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card p-2 h-100 shadow-none border">
            ...
            <div class="card-body p-4 pt-2">
              ...
              <a class="w-100 btn btn-label-primary" href="{{url('app/academy/course-details')}}"><i class="bx bx-rotate-right bx-sm me-1_5"></i>Start Over</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
  ...
  <div class="card">
    <div class="card-body row gy-6">
      <div class="col-sm-12 col-lg-4 text-center pt-md-12 px-4">
        <span class="badge bg-label-primary rounded mb-4 p-2"><i class="bx bx-gift bx-36px"></i></span>
