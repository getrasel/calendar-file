  ...
  <div class="col-xl-8 col-lg-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6">
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/account')}}"><i class="bx bx-user bx-sm me-1_5"></i>Account</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/security')}}"><i class="bx bx-lock-alt bx-sm me-1_5"></i>Security</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/billing')}}"><i class="bx bx-detail bx-sm me-1_5"></i>Billing & Plans</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/notifications')}}"><i class="bx bx-bell bx-sm me-1_5"></i>Notifications</a></li>
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="bx bx-link bx-sm me-1_5"></i>Connections</a></li>
      </ul>
    </div>
    <!--/ User Pills -->
    <!-- Connected Accounts -->
        ...
        <div class="d-flex mb-4 align-items-center">
          ...
          <div class="flex-grow-1 row align-items-center me-n1">
            ...
            <div class="col-5 text-end">
              <button class="btn btn-label-secondary btn-icon"><i class="bx bx-link bx-md"></i></button>
            </div>
          </div>
        </div>
        <div class="d-flex mb-4 align-items-center">
          ...
          <div class="flex-grow-1 row align-items-center me-n1">
            ...
            <div class="col-5 text-end">
              <button class="btn btn-label-danger btn-icon"><i class="bx bx-trash bx-md"></i></button>
            </div>
          </div>
        </div>
        <div class="d-flex mb-4 align-items-center">
