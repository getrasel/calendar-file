      ...
      <div class="card-body pt-12">
        ...
        <div class="d-flex justify-content-around flex-wrap mb-6 gap-0 gap-md-3 gap-lg-4">
          <div class="d-flex align-items-center gap-4 me-5">
            <div class="avatar">
              <div class="avatar-initial rounded bg-label-primary"><i class='bx bx-cart bx-lg'></i>
              </div>
            </div>
            <div>
  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6">
        <li class="nav-item"><a class="nav-link" href="{{url('app/ecommerce/customer/details/overview')}}"><i class="bx bx-user bx-sm me-1_5"></i>Overview</a></li>
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="bx bx-lock bx-sm me-1_5"></i>Security</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/ecommerce/customer/details/billing')}}"><i class="bx bx-map bx-sm me-1_5"></i>Address & Billing</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/ecommerce/customer/details/notifications')}}"><i class="bx bx-bell bx-sm me-1_5"></i>Notifications</a></li>
      </ul>
    </div>
    <!--/ Customer Pills -->
    <!-- Change Password -->
      ...
      <div class="card-body">
        ...
        <div class="mb-4">
          <div class="d-flex w-100 action-icons">
            ...
            <a href="javascript:;" class="btn btn-icon" data-bs-target="#enableOTP" data-bs-toggle="modal"><i class="bx bx-edit bx-md text-heading"></i></a>
            <a href="javascript:;" class="btn btn-icon"><i class="bx bx-user-plus bx-md text-heading"></i></a>
          </div>
        </div>
    ...
    <div class="card mb-6">
      ...
      <div class="table-responsive">
        <table class="table border-top table-border-bottom-0">
          ...
          <tbody>
            <tr>
              <td class="text-truncate text-heading fw-medium"><i class='bx bxl-windows bx-md text-info me-2'></i>Chrome on Windows</td>
              <td class="text-truncate">HP Spectre 360</td>
              <td class="text-truncate">Switzerland</td>
              <td class="text-truncate">10, July 2021 20:07</td>
            </tr>
            <tr>
              <td class="text-truncate text-heading fw-medium"><i class='mb-1 bx bx-mobile-alt bx-md text-danger me-2'></i>Chrome on iPhone</td>
              <td class="text-truncate">iPhone 12x</td>
              <td class="text-truncate">Australia</td>
              <td class="text-truncate">13, July 2021 10:10</td>
            </tr>
            <tr>
              <td class="text-truncate text-heading fw-medium"><i class='mb-1 bx bxl-android bx-md text-success me-2'></i>Chrome on Android</td>
              <td class="text-truncate">Oneplus 9 Pro</td>
              <td class="text-truncate">Dubai</td>
              <td class="text-truncate">14, July 2021 15:15</td>
            </tr>
            <tr>
              <td class="text-truncate text-heading fw-medium"><i class='mb-1 bx bxl-apple bx-md text-secondary me-2'></i>Chrome on MacOS</td>
