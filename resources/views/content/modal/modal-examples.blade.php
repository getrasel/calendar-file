...
<div class="row mb-6">
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-bar-chart-alt-2'></i>
        <h5>Pricing</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-credit-card'></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-buildings'></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-gift'></i>
        <h5>Refer & Earn</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-user'></i>
        <h5>Edit User</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-md-0 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-mobile-alt'></i>
        <h5>Enable OTP</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class='mb-6 bx bx-36px bx-file'></i>
        <h5>Share Project</h5>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 bx bx-lock bx-36px"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4 mb-6 mb-sm-0">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 bx bx-credit-card-alt bx-36px"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 bx bxs-credit-card bx-36px"></i>
