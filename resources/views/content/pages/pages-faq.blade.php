    ...
    <div class="d-flex justify-content-between flex-column nav-align-left mb-2 mb-md-0">
      ...
      <div class="d-none d-md-block">
        <div class="my-4 d-flex justify-content-center">
          <img src="{{asset('assets/img/illustrations/sitting-girl-with-laptop.png')}}" class="img-fluid" width="240" alt="FAQ Image">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="tab-content p-0">
        ...
        <div class="d-flex mb-4 gap-4 align-items-center">
          <div>
            <span class="badge bg-label-primary rounded w-px-50 py-2">
              <i class="bx bx-credit-card bx-26px mt-50"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-0">
        ...
        <div id="accordionPayment" class="accordion">
          <div class="card accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" aria-expanded="true" data-bs-target="#accordionPayment-1" aria-controls="accordionPayment-1">
          ...
          <div class="card accordion-item active">
            <h2 class="accordion-header">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accordionPayment-2" aria-controls="accordionPayment-2">
      ...
      <div class="tab-pane fade" id="delivery" role="tabpanel">
        <div class="d-flex mb-4 gap-4">
          <div>
            <span class="badge bg-label-primary rounded w-px-50 py-2">
              <i class="bx bx-cart bx-26px mt-50"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-0">
      ...
      <div class="tab-pane fade" id="cancellation" role="tabpanel">
        <div class="d-flex mb-4 gap-4">
          <div>
            <span class="badge bg-label-primary rounded w-px-50 py-2">
              <i class="bx bx-revision bx-26px mt-50"></i>
            </span>
          </div>
          <div>
      ...
      <div class="tab-pane fade" id="orders" role="tabpanel">
        <div class="d-flex mb-4 gap-4">
          <div>
            <span class="badge bg-label-primary rounded w-px-50 py-2">
              <i class="bx bx-box bx-26px mt-50"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-0">
      ...
      <div class="tab-pane fade" id="product" role="tabpanel">
        <div class="d-flex mb-4 gap-4">
          <div>
            <span class="badge bg-label-primary rounded w-px-50 py-2">
              <i class="bx bx-camera bx-26px mt-50"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-0">
