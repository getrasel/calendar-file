  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6">
        ...
        <li class="nav-item"><a class="nav-link" href="{{url('pages/account-settings-security')}}"><i class="bx bx-lock-alt bx-sm me-1_5"></i> Security</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('pages/account-settings-billing')}}"><i class="bx bx-detail bx-sm me-1_5"></i> Billing & Plans</a></li>
            ...
            <div class="d-flex mb-4 align-items-center">
              ...
              <div class="flex-grow-1 row">
                ...
                <div class="col-5 text-end mt-sm-0 mt-2">
                  <button class="btn btn-icon btn-label-secondary"><i class='bx bx-link bx-md'></i></button> </div>
              </div>
            </div>
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-shrink-0">
              ...
              <div class="flex-grow-1 row">
                ...
                <div class="col-5 text-end mt-sm-0 mt-2">
                  <button class="btn btn-icon btn-label-danger"><i class='bx bx-trash bx-md'></i></button> </div>
              </div>
            </div>
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-shrink-0">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 row  align-items-center">
                ...
                <div class="col-5 text-end">
                  <button class="btn btn-icon btn-label-secondary"><i class='bx bx-link bx-md'></i></button>
                </div>
              </div>
            </div>
            <!-- /Social Accounts -->
