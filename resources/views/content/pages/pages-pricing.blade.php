    ...
    <div class="container py-12 px-xl-10 px-4">
      ...
      <div class="d-flex align-items-center justify-content-center flex-wrap gap-2 pt-12 pb-6">
        ...
        <div class="mt-n5 ms-n10 ml-2 mb-10 d-none d-sm-flex align-items-center gap-1">
          <img src="{{asset('assets/img/pages/pricing-arrow-light.png')}}" alt="arrow img" class="scaleX-n1-rtl pt-1" data-app-dark-img="pages/pricing-arrow-dark.png" data-app-light-img="pages/pricing-arrow-light.png">
