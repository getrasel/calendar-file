                  ...
                  <div class="flex-grow-1">
                    <div class="row text-center text-sm-start">
                      <div class="col-md-8">
                        ...
                        <div class="text-muted mb-2 d-flex flex-wrap justify-content-center justify-content-sm-start"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-4">Apple</a> <span class="badge bg-label-success">In Stock</span></div>
      ...
      <div id="checkout-confirmation" class="content">
        <div class="row mb-6">
          <div class="col-12 col-lg-8 mx-auto text-center mb-2">
            ...
            <p><span><i class="bx bx-time-five me-1 text-heading align-top"></i> Time placed:&nbsp;</span> 25/05/2020 13:35pm</p>
          </div>
          ...
          <div class="col-12">
            <ul class="list-group list-group-horizontal-md">
              ...
              <li class="list-group-item flex-fill p-6 text-body">
                <h6 class="d-flex align-items-center gap-2"><i class="bx bx-credit-card"></i> Billing Address</h6>
                <address class="mb-0">
                  John Doe <br />
                  4135 Parkway Street,<br />
                  Los Angeles, CA 90017,<br />
              ...
              <li class="list-group-item flex-fill p-6 text-body">
                <h6 class="d-flex align-items-center gap-2"><i class="bx bxs-ship"></i> Shipping Method</h6>
