...
<div class="modal fade" id="shareProject" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-simple modal-enable-otp modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="d-flex align-items-start mt-6 align-items-sm-center mx-4 mx-md-0 mb-4 mb-md-0 p-md-6 pt-0">
        <i class="bx bx-user me-2 text-heading"></i>
        <div class="d-flex justify-content-between flex-grow-1 align-items-center flex-wrap gap-2">
          ...
          <button class="btn btn-primary"><i class='bx bx-link bx-sm me-2'></i>Copy Project Link</button>
        </div>
      </div>
    </div>
  </div>
