      ...
      <div class="modal-body">
        ...
        <div class="d-flex justify-content-between align-items-center border-bottom py-4 mb-4">
          <div class="d-flex gap-4 align-items-center">
            ...
            <img src="{{asset('assets/img/icons/payments/visa-cc.png')}}" class="img-fluid w-px-50 h-px-30 rounded" alt="visa-card" />
        ...
        <div class="d-flex justify-content-between align-items-center border-bottom pb-4 mb-4">
          <div class="d-flex gap-4 align-items-center">
            ...
            <img src="{{asset('assets/img/icons/payments/mastercard-cc.png')}}" class="img-fluid w-px-50 h-px-30 rounded" alt="master-card" />
