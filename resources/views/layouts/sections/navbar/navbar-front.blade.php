  ...
  <div class="container">
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- navbar button: Start -->
        <li>
          <a href="{{url('/auth/login-cover')}}" class="btn btn-primary" target="_blank"><span class="tf-icons bx bx-log-in-circle scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login/Register</span></a>
        </li>
        <!-- navbar button: End -->
      </ul>
      <!-- Toolbar: End -->
